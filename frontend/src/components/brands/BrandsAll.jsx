...
const BRANDS = [
  ...
  { name: "ISSEY MIYAKE", label: "이세이미야케", to: "/brand/isseymiyake", logo: logo("ISSEY MIYAKE") },
  { name: "MAISON KITSUNE", label: "메종키츠네", to: "/brand/maisonkitsune", logo: logo("MAISON KITSUNE") },
  { name: "THEORY",    label: "띠어리",     to: "/brand/theory",        logo: logo("THEORY") },
  { name: "KUHO PLUS", label: "구호플러스", to: "/brand/kuhoplus",      logo: logo("KUHO PLUS") },
  ...
  { name: "SPORTY & RICH", label: "스포티앤리치", to: "/brand/sportyrich", logo: logo("SPORTY&RICH") },
  { name: "S I E",     label: "시에",       to: "/brand/sie",           logo: logo("S I E") },

  // ── 2페이지 (12)
  { name: "ANEW GOLF", label: "아뉴골프",   to: "/brand/anewgolf",      logo: logo("ANEW GOLF") },
  { name: "GENERAL IDEA", label: "제너럴 아이디어", to: "/brand/generalidea", logo: logo("GENERAL IDEA") },
  { name: "LE MOUTON", label: "르무통",     to: "/brand/lemouton",      logo: logo("LE MOUTON") },
  { name: "AMI",       label: "아미",       to: "/brand/ami",           logo: logo("AMI") },
  { name: "JUUN.J",    label: "준지",       to: "/brand/juunj",         logo: logo("JUUN.J") },
  { name: "APERTURE",  label: "어퍼처",     to: "/brand/aperture",      logo: logo("APERTURE") },
  { name: "DANTON",    label: "단톤",       to: "/brand/danton",        logo: logo("DANTON") },
  { name: "10 CORSO COMO", label: "텐꼬르소꼬모", to: "/brand/10corso",   logo: logo("10 CORSO COMO") },
  { name: "COS",       label: "코스",       to: "/brand/cos",           logo: logo("COS") },
  { name: "SAINT JAMES", label: "세인트제임스", to: "/brand/saintjames", logo: logo("SAINT JAMES") },
  { name: "TOMMY HILFIGER", label: "타미힐피거", to: "/brand/tommyhilfiger", logo: logo("TOMMY HILFIGER") },
  { name: "ROGATIS",   label: "로가디스",   to: "/brand/rogadis",       logo: logo("ROGATIS") },

  // ── 3페이지 (12)
  { name: "CANADA GOOSE", label: "캐나다구스", to: "/brand/canadagoose", logo: logo("CANADA GOOSE") },
  { name: "HERA",      label: "헤라",       to: "/brand/hera",          logo: logo("HERA") },
  { name: "GLXY",      label: "갤럭시라이프스타일", to: "/brand/galaxylifestyle", logo: logo("GLXY") },
  ...
  { name: "KUHO",      label: "구호",       to: "/brand/kuho",          logo: logo("KUHO") }, // 여유 슬롯
  { name: "BEAKER",    label: "비이커",     to: "/brand/beaker",        logo: logo("BEAKER") }, // 여유 슬롯
];
