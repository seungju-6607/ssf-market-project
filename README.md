# ssf-market-project
[🎬 프로젝트 시연 영상 보기](https://github.com/seungju-6607/ssf-market-project/blob/main/ssf-market-project.video.mp4)
...
|       `하승주`        | `프론트엔드 UI 구현` & `백엔드 DB ` & `REST API 개발(위시리스트)` |
...
### 🤝 플리마켓
- **상품 검색** : 카테고리별 상품 목록, 검색, 필터링
- **판매글 관리** : 판매글 추가/수정/삭제 및 상태 변경, 문의 인박스
